              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  <div class="text-center">
                    @foreach($img as $row)
                      <img class="profile-user-img img-fluid img-circle admin_picture" src="{{ URL::to('/') }}/img/profileImage/{{$row->link}}" alt="User profile picture">
                    @endforeach  
                  </div>
                  ...
                  <form action="employee/changePhoto" method="post"  enctype="multipart/form-data">
                      @csrf
                      <input type="hidden" name="id" id="id" value="{{Auth::user()->id}}">
                      <input type="file" value="" name="image" class="form-control mb-2" id="image" placeholder="File Sertifikat">
