  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <!-- <div class="image">
          <img src="{{ Auth::user()->name }}" class="img-circle elevation-2 admin_picture" alt="User Image">
        </div> -->
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-compact nav-child-indent nav-collapse-hide-child nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item">
                <a href="employee/parent" class="nav-link ">
              ...
              <li class="nav-item">
                <a href="employee/child" class="nav-link ">
                  <i class="nav-icon bi bi-people-fill"></i>
                  <p>
                  Schedule Anak
                  </p>
              ...
              <li class="nav-item">
                <a href="employee/childDetail" class="nav-link ">
                  <i class="nav-icon bi bi-people-fill"></i>
                  <p>
                  Data Reporting Anak
                  </p>
