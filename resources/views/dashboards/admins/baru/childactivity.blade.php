    ...
    <div class="modal-dialog ">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Form Kegiatan Anak</h4>
        </div>
        <form class="form-horizontal" enctype="multipart/form-data" method="POST" action=" {{ url('/admin/postaktivitas') }} ">
        @csrf
          <div class="modal-body">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                                <label for="inputEmail3" class="col-sm-4">Aktivitas</label>
                         ...
                         <div class="form-group">
                            <label for="inputEmail3" class="col-sm-4">Indicator</label>
                         ...
                         <div class="form-group">
                            <label for="inputEmail3" class="col-sm-4">Evalution</label>
        
                            <div class="col-sm-8">
                              <input type="text" name="evalution" class="form-control">
