                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$row->address}}</td>
                                <td>
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-default" data-id=" {{ $row->id_biodataEmployee }} ">
                                      Edit
                                        </button>
                                    <button class="btn btn-danger" onclick="deletex( {{ $row->id_biodataEmployee }} )">Hapus</button>
                                </td>
                            </tr>
                        @endforeach
                       </tbody>
