            ...
            <div class="row">
                 ...
                 <div class="col-lg-12 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.25s">
                    ...
                    <form id="contact" method="POST" action="{{ url('/registerChild/InputForm') }}">
                        <h3 style="text-align: center">SCHEDULE ANAK</h3>
                        <br>
                        <div class="row">
                            ...
                            <table id="myTable" class="display" style="width:100%">
                                    <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Penilaian: activate to sort column ascending" style="width: 121.906px;">Jam Datang</th>
